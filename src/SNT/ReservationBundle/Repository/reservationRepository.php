...
class reservationRepository extends \Doctrine\ORM\EntityRepository
{
    public function findReservation($idReservation = '', $idClient = '', $idBien = '')
    {
        ...
        $requete = 'SELECT B.id as Bien_id, C.id as Client_id, R.id as Reservation_id, B.nomBien, B.balcon, B.meuble, B.adresse, B.prixLoc, B.surface, B.nbreChambre, B.nbreEtage, B.nbreSalon, B.nbreSallebain,B.description, B.parking,
        I.chemin,
        TB.nomTypeBien,
        Q.nomQuartier,
        V.nomVille,
        ...
        FROM RESERVATIONBundle:Bien B, RESERVATIONBundle:typeBien TB, RESERVATIONBundle:image I, RESERVATIONBundle:quartier Q, RESERVATIONBundle:ville V, RESERVATIONBundle:reservation R, RESERVATIONBundle:client C
